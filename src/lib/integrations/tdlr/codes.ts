...
// HSC's opportunity search area: GREATER HOUSTON, ~50 miles from downtown
// (Rameel 2026-09-22 — "you are showing too much stuff from Dallas";
// supersedes the earlier ~150-mile ring). Nine counties cover the radius;
// inbound bids and canopy/awning scope stay statewide regardless.
// Codes verified against the live TABS county dropdown.
